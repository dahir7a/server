...
var tr=req.body.trx_id;
  ...
  con.connect(function(err) {
    ...
    var sql="INSERT INTO transactions (amount,trxid) VALUES ('"+am+"' ,'"+tr+"'"+")";
    ...
    con.query(sql, function (err, result) {
      ...
      if(result.length>0 )
      {
        ...
        if(result[0].amount>99)
        {
          ...
          today = mm + '/' + dd + '/' + yyyy;
          var sql0="UPDATE details SET elite='"+"1"+"' WHERE username='"+user+"';";
          con.query(sql0, function (err, result) {
            if (err) return console.error(err); 
            console.log("fdsadsad");
          })
